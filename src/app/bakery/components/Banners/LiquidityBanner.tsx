  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#FFFFFF"
        mask="url(#path-1-outside-1_2_128)"
      />
      <mask
        id="mask0_2_128"
      ...
      <g mask="url(#mask0_2_128)">
        <path
          className="transition-transform duration-1000 sm:group-hover:-translate-y-[96%] sm:group-hover:translate-x-[80%]"
