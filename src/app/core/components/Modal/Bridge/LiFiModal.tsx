...
export function LiFiBridgeModal({
  ...
  const formattedXdaiAmount = formatBalance(Number(xDaiAmount), 2);

  return (
    <ModalContainer>
      <ModalHeading>Want to bake?</ModalHeading>
      <ModalContent>
        <div className="w-full border border-breadgray-rye rounded-xl p-4">
          <BridgeInfo
