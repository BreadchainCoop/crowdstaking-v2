...
export default function Home() {
  return (
    ...
    <div className={clsx(WRAPPER_CLASSES, "")}>
      ...
      <div className="mt-10 md:flex md:items-start md:justify-between md:gap-8">
        <figure className="w-[23.82rem] h-[16rem] ml-auto bg-orange-0 overflow-hidden relative right-[-1rem] mb-8 md:w-[33.125rem] md:h-[22.25rem] md:order-2 md:right-[-1.5rem] md:static md:mt-8 md:grow-0">
          <img src="/bake_hand_mobile.png" alt="" className="w-full h-full aspect-auto object-cover md:hidden" />
          <img src="/bake_hand_desktop.png" alt="" className="hidden md:block w-full h-full aspect-auto object-cover md:aspect-square" />
        </figure>
        <div className="md:max-w-[32rem]">
          <div className="max-w-[42.375rem] md:max-w-[30rem]">
            ...
            <Body>
              ...
              holds $BREAD to decide over where the interest should
              go.
            </Body>
          </div>
          <div>
